...
export const fr: Catalog = {
  ...
  'ai.settings.timeout': 'Délai maximal (minutes)',
  ...
  'ai.settings.sectionReasoning': 'Raisonnement',
  'ai.settings.reasoningEnabled': 'Laisser le modèle raisonner avant de répondre',
  'ai.settings.reasoningEffort': 'Profondeur',
  'ai.settings.effort.auto': 'Auto',
  'ai.settings.effort.low': 'Faible',
  'ai.settings.effort.medium': 'Moyenne',
  'ai.settings.effort.high': 'Élevée',
  'ai.settings.effortAutoHint': 'Auto laisse le fournisseur choisir la profondeur.',
