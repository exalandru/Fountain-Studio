...
export const en = {
  ...
  'consistency.mode.screenplay': 'Full screenplay',
  'consistency.mode.scene': 'Current scene',
  'consistency.mode.selection': 'Selection',
  'consistency.analyse': 'Analyse',
  'consistency.warning':
    'AI findings are suggestions. Verify every item against the screenplay before editing.',
  'consistency.noScene': 'Place the cursor inside a scene before running this mode.',
  'consistency.noSelection': 'Select a passage before running this mode.',
