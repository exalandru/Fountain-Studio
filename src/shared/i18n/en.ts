...
export const en = {
  ...
  'ai.settings.timeout': 'Timeout (minutes)',
  ...
  'ai.settings.sectionReasoning': 'Reasoning',
  'ai.settings.reasoningEnabled': 'Let the model reason before answering',
  'ai.settings.reasoningEffort': 'Depth',
  'ai.settings.effort.auto': 'Auto',
  'ai.settings.effort.low': 'Low',
  'ai.settings.effort.medium': 'Medium',
  'ai.settings.effort.high': 'High',
  'ai.settings.effortAutoHint': 'Auto leaves the depth to the provider.',
